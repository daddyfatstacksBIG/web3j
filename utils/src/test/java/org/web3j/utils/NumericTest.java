...
public class NumericTest {
  ...
  public void testQuantityEncodeLeadingZero() {
    assertThat(Numeric.toHexStringWithPrefixSafe(BigInteger.valueOf(0L)),
               equalTo("0x00"));
    assertThat(Numeric.toHexStringWithPrefixSafe(BigInteger.valueOf(1024L)),
               equalTo("0x400"));
    assertThat(
  ...
  public void testQuantityDecode() {
    ...
    assertThat(Numeric.decodeQuantity("0x400"),
               equalTo(BigInteger.valueOf((1024L))));
    assertThat(Numeric.decodeQuantity("0x0"),
               equalTo(BigInteger.valueOf((0L))));
    assertThat(Numeric.decodeQuantity("0x7fffffffffffffff"),
  ...
  public void testQuantityDecodeLeadingZero() {
    assertThat(Numeric.decodeQuantity("0x0400"),
               equalTo(BigInteger.valueOf(1024L)));
    assertThat(Numeric.decodeQuantity("0x001"),
  ...
  public void testQuantityEncode() {
    ...
    assertThat(Numeric.encodeQuantity(BigInteger.valueOf(Long.MAX_VALUE)),
  ...
  public void testCleanHexPrefix() {
    ...
    assertThat(Numeric.cleanHexPrefix("0123456789abcdef"),
               is("0123456789abcdef"));
    assertThat(Numeric.cleanHexPrefix("0x"), is(""));
    assertThat(Numeric.cleanHexPrefix("0x0123456789abcdef"),
               is("0123456789abcdef"));
  }
  ...
  public void testPrependHexPrefix() {
    ...
    assertThat(Numeric.prependHexPrefix("0x0123456789abcdef"),
               is("0x0123456789abcdef"));
    assertThat(Numeric.prependHexPrefix("0x"), is("0x"));
    assertThat(Numeric.prependHexPrefix("0123456789abcdef"),
               is("0x0123456789abcdef"));
  }
  ...
  public void testToHexStringNoPrefixZeroPadded() {
    assertThat(Numeric.toHexStringNoPrefixZeroPadded(BigInteger.ZERO, 5),
               is("00000"));
  ...
  public void testToHexStringWithPrefixZeroPadded() {
    assertThat(Numeric.toHexStringWithPrefixZeroPadded(BigInteger.ZERO, 5),
               is("0x00000"));
