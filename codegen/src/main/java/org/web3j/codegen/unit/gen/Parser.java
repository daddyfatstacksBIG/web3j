...
public abstract class Parser {
  ...
  public Parser(Class<?> theContract, Method method,
  ...
  protected final Object[] mergePlaceholderValues(Object[] source1,
                                                  Object[] source2) {
  ...
  protected final Object[] concludeMethodReturnType() {
    ...
    if (returnType.equals(theContract)) {
      return new Object[] {toCamelCase(returnTypeAsLiteral(returnType, false)),
                           returnType};
    } else {
