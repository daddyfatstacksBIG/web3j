...
/**
 * Class that generates the unit tests classes for the contracts. The class
 * writes to src/test/java/contracts and each file is named after the contract +
 * "Test" e.g GreeterTest
 */
public class JavaClassGenerator implements UnitClassGenerator {
  ...
  public JavaClassGenerator(final Class theContract, final String packageName,
                            String writePath) {
  ...
  public void writeClass() throws IOException {
    ...
    AnnotationSpec.Builder annotationSpec =
        AnnotationSpec.builder(EVM_ANNOTATION);
    ...
    TypeSpec testClass =
        TypeSpec.classBuilder(theContract.getSimpleName() + "Test")
            .addMethods(
                MethodFilter.generateMethodSpecsForEachTest(theContract))
