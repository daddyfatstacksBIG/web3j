...
public class KotlinClassGenerator implements UnitClassGenerator {
  ...
  public KotlinClassGenerator(final Class theContract, final String packageName,
                              String writePath) {
  ...
  public void writeClass() throws Exception {
    ...
    TypeSpec testClass =
        TypeSpec.classBuilder(theContract.getSimpleName() + "Test")
            .addFunctions(
                MethodFilter.generateFunctionSpecsForEachTest(theContract))
