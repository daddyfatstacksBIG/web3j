 ...
 * the Solidity ABI formatted JSON in its own format. That format also gives
 * access to the binary code. It also contains information about deployment
 * addresses. This should make integration with Truffle easier.
 */
...
public class TruffleJsonFunctionWrapperGenerator
  ...
  private TruffleJsonFunctionWrapperGenerator(String jsonFileLocation,
                                              String destinationDirLocation,
                                              String basePackageName,
                                              boolean useJavaNativeTypes) {

    super(new File(destinationDirLocation), basePackageName,
          useJavaNativeTypes);
  ...
  public static void main(String[] args) throws Exception {
    ...
    String destinationDirLocation =
        parseParameterArgument(fullArgs, "-o", "--outputDir");
    String basePackageName =
        parseParameterArgument(fullArgs, "-p", "--package");
    ...
    new TruffleJsonFunctionWrapperGenerator(jsonFileLocation,
                                            destinationDirLocation,
                                            basePackageName, useJavaNativeTypes)
        .generate();
  }
  ...
  public void generate() throws IOException, ClassNotFoundException {
    ...
    if (c == null) {
      ...
      new SolidityFunctionWrapper(useJavaNativeTypes, Address.DEFAULT_LENGTH)
          .generateJavaFiles(contractName, c.getBytecode(), c.getAbi(),
   ...
   * Truffle Contract
   *
   * <p>Describes a contract exported by and consumable by Truffle, which may
   * include information about deployed instances on networks.
   */
  @JsonInclude(JsonInclude.Include.NON_NULL)
  @JsonPropertyOrder({"contractName", "abi", "bytecode", "deployedBytecode",
                      "sourceMap", "deployedSourceMap", "source", "sourcePath",
                      "ast", "compiler", "networks", "schemaVersion",
                      "updatedAt"})
  public static class Contract {
    ...
    @JsonProperty("sourceMap") public String sourceMap;

    @JsonProperty("deployedSourceMap") public String deployedSourceMap;

    @JsonProperty("source") public String source;

    @JsonProperty("sourcePath") public String sourcePath;

    @JsonProperty("ast") public JsonNode ast;

    @JsonProperty("compiler") public Compiler compiler;

    @JsonProperty("networks") public Map<String, NetworkInfo> networks;
    ...
    public Contract(String contractName, List<AbiDefinition> abi,
                    String bytecode, String deployedBytecode, String sourceMap,
                    String deployedSourceMap, String source, String sourcePath,
                    JsonNode ast, Compiler compiler,
                    Map<String, NetworkInfo> networks, String schemaVersion,
                    Date updatedAt) {
      super();
    ...
    public List<AbiDefinition> getAbi() { return abi; }
     ...
     * @return the contract's address or <code>null</code> if there isn't one
     *     known.
     */
  ...
  public static class NetworkInfo {
    ...
    @JsonProperty("events") public Map<String, JsonNode> events;

    @JsonProperty("links") public Map<String, JsonNode> links;

    @JsonProperty("address") public String address;

    public NetworkInfo() {}

    public NetworkInfo(Map<String, JsonNode> events,
                       Map<String, JsonNode> links, String address) {
      super();
      this.events = events;
      this.links = links;
