...
public class SolidityFunctionWrapperGeneratorTest extends TempFileProvider {
  ...
  public void setUp() throws Exception {
    ...
    URL url = SolidityFunctionWrapperGeneratorTest.class.getClass().getResource(
        "/solidity");
  ...
  public void testContractsNoBin() throws Exception {
    testCodeGeneration("contracts", "HumanStandardToken", JAVA_TYPES_ARG,
                       false);
    testCodeGeneration("contracts", "HumanStandardToken", SOLIDITY_TYPES_ARG,
                       false);
  }
  ...
  public void testDuplicateField() throws Exception {
    ...
    testCodeGeneration("duplicate", "DuplicateField", SOLIDITY_TYPES_ARG,
                       false);
  ...
  public void testGenerationCommandPrefixes() throws Exception {
    ...
    testCodeGeneration(Arrays.asList(COMMAND_GENERATE), "contracts",
                       "HumanStandardToken", SOLIDITY_TYPES_ARG, true);
  }
  ...
  private void testCodeGenerationJvmTypes(String contractName,
  ...
  private void testCodeGenerationJvmTypes(String contractName,
    ...
    testCodeGeneration(emptyList(), contractName, inputFileName, JAVA_TYPES_ARG,
                       true, primitive);
  }

  private void testCodeGenerationSolidityTypes(String contractName,
                                               String inputFileName)
      throws Exception {
  ...
  private void testCodeGeneration(String contractName, String inputFileName,
                                  String types, boolean useBin)
      throws Exception {
    testCodeGeneration(emptyList(), contractName, inputFileName, types, useBin);
  }

  private void testCodeGeneration(List<String> prefixes, String contractName,
                                  String inputFileName, String types,
                                  boolean useBin) throws Exception {
    testCodeGeneration(prefixes, contractName, inputFileName, types, useBin,
                       false);
  }

  private void testCodeGeneration(List<String> prefixes, String contractName,
                                  String inputFileName, String types,
                                  boolean useBin, boolean primitives)
      throws Exception {
    ...
    if (useBin) {
      options.add("-b");
      options.add(solidityBaseDir + File.separator + contractName +
                  File.separator + "build" + File.separator + inputFileName +
                  ".bin");
    }
    options.add("-a");
    options.add(solidityBaseDir + File.separator + contractName +
