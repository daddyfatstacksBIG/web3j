...
public class TruffleJsonFunctionWrapperGeneratorTest extends TempFileProvider {
  ...
  private static void verifyGeneratedCode(String sourceFile)
      throws IOException {
  ...
  private void testCodeGenerationJvmTypes(String contractName,
    ...
    testCodeGeneration(contractName, inputFileName, PackageName,
                       JAVA_TYPES_ARG);
  }

  @SuppressWarnings("SameParameterValue")
  private void testCodeGenerationSolidtyTypes(String contractName,
                                              String inputFileName)
      throws Exception {
  ...
  private void testCodeGeneration(String contractName, String inputFileName,
                                  String packageName, String types)
      throws Exception {
