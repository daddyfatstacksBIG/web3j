...
public class InfuraHttpServiceTest {
  ...
  public void testBuildHeader() {
    ...
    assertEquals(buildClientVersionHeader("geth 1.4.19", true),
                 (Collections.singletonMap("Infura-Ethereum-Preferred-Client",
                                           "geth 1.4.19")));

    assertEquals(buildClientVersionHeader("geth 1.4.19", false),
                 (Collections.singletonMap("Infura-Ethereum-Preferred-Client",
