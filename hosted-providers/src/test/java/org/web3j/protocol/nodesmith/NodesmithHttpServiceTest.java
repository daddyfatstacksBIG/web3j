...
public class NodesmithHttpServiceTest {
  ...
  public void testParseHeaders() {
    Optional<RateLimitInfo> info =
        NodesmithHttpService.createRateLimitFromHeaders(
            Headers.of(NodesmithHttpService.NS_RATELIMIT_LIMIT, "500",
  ...
  public void testParseHeader_FailureCases() {
    ...
    assertFalse(NodesmithHttpService
                    .createRateLimitFromHeaders(Headers.of(
    ...
    // Null headers
    assertFalse(
        NodesmithHttpService.createRateLimitFromHeaders(null).isPresent());
  }
}
