...
/**
 * HttpService for working with <a href="https://nodesmith.io/">Nodesmith's</a>
...
public class NodesmithHttpService extends HttpService {
  ...
  public NodesmithHttpService(String url) { super(url); }
  ...
  static Optional<RateLimitInfo> createRateLimitFromHeaders(Headers headers) {
    ...
    return RateLimitInfo.createFromHeaders(headers.get(NS_RATELIMIT_LIMIT),
