 ...
 *
 * @see <a href="https://beta.docs.nodesmith.io/#/ethereum/rateLimiting">Rate
 *     Limiting</a>
 */
public class RateLimitInfo {
   ...
   */
  public long getTotalAllowedInWindow() { return this.limit; }
   ...
   */
  public long getRemainingInWindow() { return this.remaining; }
   ...
   */
  public Instant getWindowResetTime() { return this.resetTime; }

  /**
   * Tries to create a new instance of the RateLimitInfo class from the headers
   * passed in. If successful, it returns the instance wrapped in Optional,
   ...
   * @return If successful, RateLimitInfo wrapped in Optional, otherwise
   *     Optional.empty().
   */
  public static Optional<RateLimitInfo>
  createFromHeaders(String limitValue, String remainingValue,
