...
/**
 * HttpService for working with <a href="https://infura.io/">Infura</a>
 * clients.
 */
public class InfuraHttpService extends HttpService {
  ...
  public InfuraHttpService(String url) { this(url, "", false); }

  static Map<String, String> buildClientVersionHeader(String clientVersion,
                                                      boolean required) {
    ...
    if (required) {
      return Collections.singletonMap(INFURA_ETHEREUM_PREFERRED_CLIENT,
                                      clientVersion);
    } else {
      return Collections.singletonMap(INFURA_ETHEREUM_PREFERRED_CLIENT,
                                      clientVersion + "; required=false");
    }
  }
}
