...
public class WalletFileTest {
  ...
  public void equalsAndHashCodeTest() throws IOException {
    ...
    WalletFile walletFile1 =
        objectMapper.readValue(AES_128_CTR, WalletFile.class);

    WalletFile.Crypto crypto = new WalletFile.Crypto();
    crypto.setCipher("aes-128-ctr");
    crypto.setCiphertext(
        "7ad5c9dd2c95f34a92ebb86740b92103a5d1cc4c2eabf3b9a59e1f83f3181216");
    crypto.setKdf("pbkdf2");
    crypto.setMac(
        "2b29e4641ec17f4dc8b86fc8592090b50109b372529c30b001d4d96249edaf62");
    ...
    kdfParams.setSalt(
        "0e4cf3893b25bb81efaae565728b5b7cde6a84e224cbf9aed3d69a31c981b702");
