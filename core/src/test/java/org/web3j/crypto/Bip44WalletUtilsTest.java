...
public class Bip44WalletUtilsTest {
  ...
  public void generateBip44KeyPair() {
    ...
    Bip32ECKeyPair bip44Keypair =
        Bip44WalletUtils.generateBip44KeyPair(masterKeypair);
  ...
  public void testGenerateBip44Wallets() throws Exception {
    Bip39Wallet wallet =
        Bip44WalletUtils.generateBip44Wallet(PASSWORD, tempDir);
    ...
    assertEquals(credentials, Bip44WalletUtils.loadBip44Credentials(
