...
public class ContractTest extends ManagedTransactionTester {
  ...
  public void testDeploy() throws Exception {
    ...
    assertThat(deployedContract.getTransactionReceipt().get(),
  ...
  public void testDeployInvalidContractAddress() throws Throwable {
    ...
    try {
      TestContract
          .deployRemoteCall(TestContract.class, web3j, SampleKeys.CREDENTIALS,
                            ManagedTransaction.GAS_PRICE, Contract.GAS_LIMIT,
                            "0xcafed00d", encodedConstructor, BigInteger.ZERO)
          .send();
  ...
  public void testCallMultipleValue() throws Exception {
    ...
    assertThat(contract.callMultipleValue().send(),
               equalTo(Arrays.asList(new Uint256(BigInteger.valueOf(55)),
  ...
  public void testStaticGasProvider() throws IOException, TransactionException {
    ...
    Function func = new Function("test", Arrays.<Type>asList(),
  ...
  private static class TestContract extends Contract {
    public TestContract(String contractAddress, Web3j web3j,
                        ...
                        BigInteger gasLimit) {
      super(TEST_CONTRACT_BINARY, contractAddress, web3j, credentials, gasPrice,
            gasLimit);
    }
    ...
    public RemoteCall<TransactionReceipt> performTransaction(Address address,
                                                             Uint256 amount) {
      Function function =
          new Function("approve", Arrays.<Type>asList(address, amount),
                       Collections.<TypeReference<?>>emptyList());
    ...
    processEvent(TransactionReceipt transactionReceipt) {
      Event event = new Event("Event", Arrays.<TypeReference<?>>asList(
