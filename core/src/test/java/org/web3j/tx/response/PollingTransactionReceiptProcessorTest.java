...
public class PollingTransactionReceiptProcessorTest {
  ...
  @Test
  public void returnsTransactionReceiptWhenItIsAvailableInstantly()
      throws Exception {
  ...
  @Test
  public void throwsTransactionExceptionWhenReceiptIsNotAvailableInTime()
      throws Exception {
  ...
  private static <T extends Response<?>> Request<String, T>
  requestReturning(T response) {
  ...
  private static EthGetTransactionReceipt
