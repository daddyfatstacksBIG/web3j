...
public class RequestTest extends RequestTester {
  ...
  public void testWeb3Sha3() throws Exception {
    ...
    verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"web3_sha3\","
  ...
  public void testEthGetBalance() throws Exception {
    web3j
        .ethGetBalance("0x407d73d8a49eeb85d32cf465507dd71d507100c1",
  ...
  public void testEthGetStorageAt() throws Exception {
    web3j
        .ethGetStorageAt("0x295a70b2de5e3953354a6a8344e616ed314d7251",
                         BigInteger.ZERO, DefaultBlockParameterName.LATEST)
        .send();
  ...
  public void testEthGetTransactionCount() throws Exception {
    web3j
        .ethGetTransactionCount("0x407d73d8a49eeb85d32cf465507dd71d507100c1",
                                DefaultBlockParameterName.LATEST)
        .send();
  ...
  public void testEthGetCode() throws Exception {
    web3j
        .ethGetCode("0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b",
  ...
  public void testEthSendTransaction() throws Exception {
    web3j
        .ethSendTransaction(new Transaction(
            "0xb60e8dd61c5d32be8058bb8eb970870f07233155", BigInteger.ONE,
  ...
  public void testEthCall() throws Exception {
    web3j
        .ethCall(Transaction.createEthCallTransaction(
                     ...
                     "0xb60e8dd61c5d32be8058bb8eb970870f07233155", "0x0"),
  ...
  public void testEthEstimateGasContractCreation() throws Exception {
    web3j
        .ethEstimateGas(Transaction.createContractTransaction(
  ...
  public void testEthGetBlockByNumber() throws Exception {
    web3j
        .ethGetBlockByNumber(
            DefaultBlockParameter.valueOf(Numeric.toBigInt("0x1b4")), true)
        .send();
  ...
  public void testEthGetTransactionByBlockNumberAndIndex() throws Exception {
    web3j
        .ethGetTransactionByBlockNumberAndIndex(
            DefaultBlockParameter.valueOf(Numeric.toBigInt("0x29c")),
            BigInteger.ZERO)
        .send();
  ...
  public void testEthGetLogs() throws Exception {
    web3j
        .ethGetLogs(new EthFilter().addSingleTopic(
  ...
  public void testShhPost() throws Exception {
    ...
    web3j
        .shhPost(new ShhPost(
            ...
            Arrays.asList("0x776869737065722d636861742d636c69656e74",
                          "0x4d5a695276454c39425154466b61693532"),
            "0x7b2274797065223a226d6", Numeric.toBigInt("0x64"),
  ...
  public void testShhNewIdentity() throws Exception {
    ...
    verifyResult(
        "{\"jsonrpc\":\"2.0\",\"method\":\"shh_newIdentity\",\"params\":[],\"id\":1}");
  }
  ...
  public void testShhNewGroup() throws Exception {
    ...
    verifyResult(
        "{\"jsonrpc\":\"2.0\",\"method\":\"shh_newGroup\",\"params\":[],\"id\":1}");
  }
