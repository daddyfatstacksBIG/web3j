...
public class ResponseTest extends ResponseTester {
  ...
  public void testAdminNodeInfo() throws Exception {
    ...
    assertThat(adminNodeInfo.getResult().getName(),
  ...
  public void testEthGasPrice() {
    ...
    assertThat(ethGasPrice.getGasPrice(),
               equalTo(BigInteger.valueOf(10000000000000L)));
  }
  ...
  public void testEthBlockNumber() {
    ...
    assertThat(ethBlockNumber.getBlockNumber(),
               equalTo(BigInteger.valueOf(1207L)));
  }
  ...
  public void testEthGetBalance() {
    ...
    assertThat(ethGetBalance.getBalance(),
               equalTo(BigInteger.valueOf(158972490234375000L)));
  }
  ...
  public void testEthGetTransactionCount() {
    ...
    assertThat(ethGetTransactionCount.getTransactionCount(),
  ...
  public void testEthCallReverted() {
    ...
    assertThat(ethCall.getRevertReason(),
               is("Solidity uses state-reverting exceptions to "
  ...
  public void testEthEstimateGas() {
    ...
    assertThat(ethEstimateGas.getAmountUsed(),
               equalTo(BigInteger.valueOf(21000)));
  }
  ...
  public void testEthGetCompilers() {
    ...
    assertThat(ethGetCompilers.getCompilers(),
  ...
  public void testEthCompileSolidity() {
    ...
    assertThat(ethCompileSolidity.getCompiledSolidity(),
               equalTo(compiledSolidity));
  }
