...
public class RequestTest extends RequestTester {
  ...
  public void testPersonalSendTransaction() throws Exception {
    web3j
        .personalSendTransaction(new Transaction("FROM", BigInteger.ONE,
  ...
  public void testPersonalUnlockAccount() throws Exception {
    web3j
        .personalUnlockAccount("0xfc390d8a8ddb591b010fda52f4db4945742c3809",
                               "hunter2", BigInteger.ONE)
        .send();
  ...
  public void testTxPoolContent() throws Exception {
    ...
    verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"txpool_content\","
                 + "\"params\":[],\"id\":1}");
  }
}
