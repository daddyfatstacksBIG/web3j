...
public class ResponseTest extends ResponseTester {
  ...
  public void testNewAccountIdentifier() {
    ...
    assertEquals(newAccountIdentifier.getAccountId(),
  ...
  public void testPersonalListAccounts() {
    ...
    assertEquals(personalListAccounts.getAccountIds(),
                 (Arrays.asList("0x7bf87721a96849d168de02fd6ea5986a3a147383",
                                "0xca807a90fd64deed760fb98bf0869b475c469348")));
  }
  ...
  public void testTxPoolContent() {
    ...
    assertEquals(content.getResult().getPendingTransactions().get(0).getFrom(),
                 "0x0032d05f320fa74c871e892f48f0e6387c0dfe95");
    assertEquals(content.getResult().getQueuedTransactions().get(0).getFrom(),
                 "0x00bf700ceb382877f8bfa38b05fcc81126f4f228");
  }
}
