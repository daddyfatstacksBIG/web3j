...
public class WalletFile {
  ...
  public boolean equals(Object o) {
    ...
    if (getCrypto() != null ? !getCrypto().equals(that.getCrypto())
                            : that.getCrypto() != null) {
      return false;
    }
  ...
  public static class Crypto {
    ...
    public CipherParams getCipherparams() { return cipherparams; }
    ...
    public KdfParams getKdfparams() { return kdfparams; }

    @JsonTypeInfo(use = JsonTypeInfo.Id.NAME,
                  include = JsonTypeInfo.As.EXTERNAL_PROPERTY, property = "kdf")
    @JsonSubTypes({
      @JsonSubTypes.
      Type(value = Aes128CtrKdfParams.class, name = Wallet.AES_128_CTR)
      ,
          @JsonSubTypes.Type(value = ScryptKdfParams.class,
                             name = Wallet.SCRYPT)
    })
    // To support my Ether Wallet keys uncomment this annotation & comment out
    // the above
    ...
    public boolean equals(Object o) {
      ...
      if (getCipher() != null ? !getCipher().equals(that.getCipher())
                              : that.getCipher() != null) {
        return false;
      }
      ...
      if (getKdf() != null ? !getKdf().equals(that.getKdf())
                           : that.getKdf() != null) {
        return false;
      }
      if (getKdfparams() != null ? !getKdfparams().equals(that.getKdfparams())
                                 : that.getKdfparams() != null) {
        return false;
      }
      return getMac() != null ? getMac().equals(that.getMac())
                              : that.getMac() == null;
    }
  ...
  public static class CipherParams {
    ...
    public boolean equals(Object o) {
      ...
      return getIv() != null ? getIv().equals(that.getIv())
                             : that.getIv() == null;
    }
  ...
  public static class Aes128CtrKdfParams implements KdfParams {
    ...
    public int getDklen() { return dklen; }

    public void setDklen(int dklen) { this.dklen = dklen; }
    ...
    public boolean equals(Object o) {
      ...
      if (getPrf() != null ? !getPrf().equals(that.getPrf())
                           : that.getPrf() != null) {
        return false;
      }
      return getSalt() != null ? getSalt().equals(that.getSalt())
                               : that.getSalt() == null;
    }
  ...
  // see the following issue https://github.com/kvhnuke/etherwallet/issues/269
  static class KdfParamsDeserialiser extends JsonDeserializer<KdfParams> {

    @Override
    public KdfParams deserialize(JsonParser jsonParser,
      ...
      // it would be preferable to detect the class to use based on the kdf
      // parameter in the container object instance
