...
public class Bip44WalletUtils extends WalletUtils {
  ...
  /**
   * Generates a BIP-44 compatible Ethereum wallet on top of BIP-39 generated
   * seed.
   *
   ...
   */
  public static Bip39Wallet generateBip44Wallet(String password,
  ...
  public static Bip32ECKeyPair generateBip44KeyPair(Bip32ECKeyPair master,
    ...
    if (testNet) {
      // /m/44'/0'/0
      final int[] path = {44 | HARDENED_BIT, 0 | HARDENED_BIT, 0 | HARDENED_BIT,
                          0};
      return Bip32ECKeyPair.deriveKeyPair(master, path);
    } else {
      // m/44'/60'/0'/0
      final int[] path = {44 | HARDENED_BIT, 60 | HARDENED_BIT,
                          0 | HARDENED_BIT, 0};
      return Bip32ECKeyPair.deriveKeyPair(master, path);
    }
  }

  public static Credentials loadBip44Credentials(String password,
                                                 String mnemonic) {
    return loadBip44Credentials(password, mnemonic, false);
  }

  public static Credentials
  loadBip44Credentials(String password, String mnemonic, boolean testNet) {
