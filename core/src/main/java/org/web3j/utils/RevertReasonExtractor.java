...
public class RevertReasonExtractor {
  ...
  /**
   * Extracts the error reason of a reverted transaction (if one exists and
   * enabled).
   *
  ...
  extractRevertReason(TransactionReceipt transactionReceipt, String data,
                      Web3j web3j, Boolean revertReasonCallEnabled)
      throws IOException {
    ...
    if (transactionReceipt.getRevertReason() != null) {
      ...
      String revertReason =
          retrieveRevertReason(transactionReceipt, data, web3j);
   ...
   */
  public static String
  retrieveRevertReason(TransactionReceipt transactionReceipt, String data,
