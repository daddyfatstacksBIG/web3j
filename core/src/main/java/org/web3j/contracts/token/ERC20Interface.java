 ...
 *
 * <p>Implementations should provide the concrete
 * <code>ApprovalEventResponse</code> and <code> TransferEventResponse</code>
 ...
 * @see <a href="https://github.com/ethereum/EIPs/issues/20">ERC: Token standard
 *     #20</a>
 */
...
public interface ERC20Interface<R, T> extends ERC20BasicInterface<T> {
  ...
  RemoteCall<TransactionReceipt> transferFrom(String from, String to,
                                              BigInteger value);
