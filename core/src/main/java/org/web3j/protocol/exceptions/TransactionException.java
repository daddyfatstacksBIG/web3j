...
/**
 * Transaction timeout exception indicates that we have breached some threshold
 * waiting for a transaction to execute.
 */
public class TransactionException extends Exception {
   ...
   */
  public Optional<String> getTransactionHash() { return transactionHash; }
}
