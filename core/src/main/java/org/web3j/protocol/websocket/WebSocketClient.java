...
/**
 * Web socket client implementation that connects to a specify URI. Allows to
 * provide a listener that will be called when a new message is received by the
 * client.
 */
public class WebSocketClient extends org.java_websocket.client.WebSocketClient {
  ...
  public WebSocketClient(URI serverUri) { super(serverUri); }
  ...
  /**
   * Set a listener that will be called when a new message is received by the
   * client.
   *
