...
public class HttpService extends Service {
  ...
  private static final CipherSuite[] INFURA_CIPHER_SUITES = new CipherSuite[] {
      ...
      // Note that the following cipher suites are all on HTTP/2's bad cipher
      // suites list. We'll continue to include them until better suites are
      // commonly available. For example, none of the better cipher suites
      // listed above shipped with Android 4.4 or Java 7.
  ...
  protected InputStream performIO(String request) throws IOException {
    ...
    if (response.isSuccessful()) {
      ...
      throw new ClientConnectionException("Invalid response received: " + code +
                                          "; " + text);
    }
  }
