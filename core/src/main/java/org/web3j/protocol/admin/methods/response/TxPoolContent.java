...
/** txpool_content */
public final class TxPoolContent
    extends Response<TxPoolContent.TxPoolContentResult> {
  public static class TxPoolContentResult {
    ...
    public TxPoolContentResult(
      ...
      this.pending = immutableCopy(
          pending, val -> immutableCopy(val, Function.identity()));
      this.queued =
          immutableCopy(queued, val -> immutableCopy(val, Function.identity()));
    }
    ...
    private static <K, V> Map<K, V> immutableCopy(Map<K, V> map,
