...
public class AdminNodeInfo extends Response<AdminNodeInfo.NodeInfo> {
  ...
  public static class NodeInfo {
    ...
    public NodeInfo(String enode, String id, String ip, String listenAddr,
                    String name) {
      this.enode = enode;
      this.id = id;
      this.ip = ip;
    ...
    public String getListenAddr() { return listenAddr; }
  ...
  public static class ResponseDeserialiser extends JsonDeserializer<NodeInfo> {
    ...
    @Override
    public NodeInfo deserialize(JsonParser jsonParser,
