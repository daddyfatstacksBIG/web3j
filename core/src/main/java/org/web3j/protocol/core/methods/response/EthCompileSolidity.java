...
/** eth_compileSolidity. */
public class EthCompileSolidity
    extends Response<Map<String, EthCompileSolidity.Code>> {

  public Map<String, Code> getCompiledSolidity() { return getResult(); }
  ...
  public static class Code {
    ...
    public SolidityInfo getInfo() { return info; }

    public void setInfo(SolidityInfo info) { this.info = info; }
    ...
    public boolean equals(Object o) {
      ...
      if (getCode() != null ? !getCode().equals(code1.getCode())
                            : code1.getCode() != null) {
        return false;
      }
      return getInfo() != null ? getInfo().equals(code1.getInfo())
                               : code1.getInfo() == null;
    }
  ...
  public static class SolidityInfo {
    ...
    public List<AbiDefinition> getAbiDefinition() { return abiDefinition; }

    public void setAbiDefinition(List<AbiDefinition> abiDefinition) {
      this.abiDefinition = abiDefinition;
    }

    public Documentation getUserDoc() { return userDoc; }

    public void setUserDoc(Documentation userDoc) { this.userDoc = userDoc; }

    public Documentation getDeveloperDoc() { return developerDoc; }
    ...
    public boolean equals(Object o) {
      ...
      if (getSource() != null ? !getSource().equals(that.getSource())
                              : that.getSource() != null) {
        return false;
      }
      ...
      if (getUserDoc() != null ? !getUserDoc().equals(that.getUserDoc())
    ...
    public int hashCode() {
      ...
      result =
          31 * result + (getLanguage() != null ? getLanguage().hashCode() : 0);
      result =
          31 * result +
      ...
      result = 31 * result +
               (getAbiDefinition() != null ? getAbiDefinition().hashCode() : 0);
      result =
          31 * result + (getUserDoc() != null ? getUserDoc().hashCode() : 0);
      result = 31 * result +
               (getDeveloperDoc() != null ? getDeveloperDoc().hashCode() : 0);
      return result;
    }
  }
  ...
  public static class Documentation {
    ...
    public Documentation() { this.methods = Collections.emptyMap(); }
    ...
    public boolean equals(Object o) {
      ...
      return getMethods() != null ? getMethods().equals(that.getMethods())
