...
public class TransactionReceipt {
  ...
  public TransactionReceipt(String transactionHash, String transactionIndex,
                            ...
                            String cumulativeGasUsed, String gasUsed,
                            String contractAddress, String root, String status,
                            String from, String to, List<Log> logs,
                            String logsBloom, String revertReason) {
  ...
  public String getTransactionIndexRaw() { return transactionIndex; }
  ...
  public String getBlockNumberRaw() { return blockNumber; }
  ...
  public String getCumulativeGasUsedRaw() { return cumulativeGasUsed; }
  ...
  public boolean equals(Object o) {
    ...
    if (getBlockHash() != null ? !getBlockHash().equals(that.getBlockHash())
                               : that.getBlockHash() != null) {
      return false;
    }
    if (blockNumber != null ? !blockNumber.equals(that.blockNumber)
    ...
    if (gasUsed != null ? !gasUsed.equals(that.gasUsed)
                        : that.gasUsed != null) {
      return false;
    }
    ...
    if (getRoot() != null ? !getRoot().equals(that.getRoot())
                          : that.getRoot() != null) {
      return false;
    }
    if (getStatus() != null ? !getStatus().equals(that.getStatus())
                            : that.getStatus() != null) {
      return false;
    }
    ...
    if (getLogs() != null ? !getLogs().equals(that.getLogs())
                          : that.getLogs() != null) {
      return false;
    }
    if (getLogsBloom() != null ? !getLogsBloom().equals(that.getLogsBloom())
  ...
  public int hashCode() {
    ...
    result = 31 * result +
             (transactionIndex != null ? transactionIndex.hashCode() : 0);
    result =
        31 * result + (getBlockHash() != null ? getBlockHash().hashCode() : 0);
    result = 31 * result + (blockNumber != null ? blockNumber.hashCode() : 0);
    result = 31 * result +
             (cumulativeGasUsed != null ? cumulativeGasUsed.hashCode() : 0);
    result = 31 * result + (gasUsed != null ? gasUsed.hashCode() : 0);
    result =
        31 * result +
        (getContractAddress() != null ? getContractAddress().hashCode() : 0);
    ...
    result =
        31 * result + (getLogsBloom() != null ? getLogsBloom().hashCode() : 0);
    result = 31 * result +
             (getRevertReason() != null ? getRevertReason().hashCode() : 0);
    return result;
  }
  ...
  public String toString() {
    return "TransactionReceipt{"
        ...
        ", transactionIndex='" + transactionIndex + '\'' + ", blockHash='" +
        blockHash + '\'' + ", blockNumber='" + blockNumber + '\'' +
        ", cumulativeGasUsed='" + cumulativeGasUsed + '\'' + ", gasUsed='" +
        gasUsed + '\'' + ", contractAddress='" + contractAddress + '\'' +
        ", root='" + root + '\'' + ", status='" + status + '\'' + ", from='" +
        from + '\'' + ", to='" + to + '\'' + ", logs=" + logs +
        ", logsBloom='" + logsBloom + '\'' + ", revertReason='" + revertReason +
        '\'' + '}';
  }
}
