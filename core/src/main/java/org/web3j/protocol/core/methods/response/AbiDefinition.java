...
public class AbiDefinition {
   ...
   *
   * <p>this does not factor into the <code>#hashCode()</code> or
   * <code>#equals()</code> logic since multiple functions with the same
   * signature that only differ in mutability are not allowed in Solidity.
   *
   * <p>Valid values are:
   *
   * <ul>
  ...
  public List<NamedType> getInputs() { return inputs; }

  public void setInputs(List<NamedType> inputs) { this.inputs = inputs; }

  public String getName() { return name; }

  public void setName(String name) { this.name = name; }

  public List<NamedType> getOutputs() { return outputs; }

  public boolean hasOutputs() { return !outputs.isEmpty(); }

  public void setOutputs(List<NamedType> outputs) { this.outputs = outputs; }
  ...
  public boolean equals(Object o) {
    ...
    if (getInputs() != null ? !getInputs().equals(that.getInputs())
                            : that.getInputs() != null) {
      return false;
    }
    ...
    if (getOutputs() != null ? !getOutputs().equals(that.getOutputs())
  ...
  public int hashCode() {
    ...
    result =
        31 * result +
        (getStateMutability() != null ? getStateMutability().hashCode() : 0);
    return result;
  }
  ...
  public static class NamedType {
    ...
    public boolean equals(Object o) {
      ...
      if (getName() != null ? !getName().equals(namedType.getName())
                            : namedType.getName() != null) {
        return false;
      }
      return getType() != null ? getType().equals(namedType.getType())
