 ...
 *
 * <p>See <a
 * href="https://github.com/ethereum/wiki/wiki/JSON-RPC#eth_getfilterchanges">docs</a>
 * for further details.
 */
public class EthLog extends Response<List<EthLog.LogResult>> {
  ...
  public List<LogResult> getLogs() { return getResult(); }

  public interface LogResult<T> { T get(); }
  ...
  public static class LogObject extends Log implements LogResult<Log> {
    ...
    public LogObject(boolean removed, String logIndex, String transactionIndex,
                     String transactionHash, String blockHash,
                     String blockNumber, String address, String data,
                     String type, List<String> topics) {
      super(removed, logIndex, transactionIndex, transactionHash, blockHash,
            blockNumber, address, data, type, topics);
    }
  ...
  public static class Hash implements LogResult<String> {
    ...
    public Hash(String value) { this.value = value; }
