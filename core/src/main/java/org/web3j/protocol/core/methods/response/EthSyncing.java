...
public class EthSyncing extends Response<EthSyncing.Result> {
  ...
  public boolean isSyncing() { return getResult().isSyncing(); }
  ...
  // these fields although not present in the RPC specification are returned by
  // Geth 1.4.10
  public static class Syncing extends Result {
    ...
    public Syncing(String startingBlock, String currentBlock,
                   String highestBlock, String knownStates,
                   String pulledStates) {
    ...
    public boolean equals(Object o) {
      ...
      if (knownStates != null ? !knownStates.equals(syncing.knownStates)
                              : syncing.knownStates != null) {
        return false;
      }
      return pulledStates != null ? pulledStates.equals(syncing.pulledStates)
    ...
    public int hashCode() {
      int result =
          getStartingBlock() != null ? getStartingBlock().hashCode() : 0;
      result = 31 * result + Boolean.hashCode(isSyncing());
      result = 31 * result +
               (getCurrentBlock() != null ? getCurrentBlock().hashCode() : 0);
      result = 31 * result +
               (getHighestBlock() != null ? getHighestBlock().hashCode() : 0);
      result = 31 * result + (knownStates != null ? knownStates.hashCode() : 0);
      result =
          31 * result + (pulledStates != null ? pulledStates.hashCode() : 0);
      return result;
    }
  }
  ...
  public static class ResponseDeserialiser extends JsonDeserializer<Result> {
    ...
    @Override
    public Result deserialize(JsonParser jsonParser,
