...
public class RemoteCall<T> {
  ...
  public RemoteCall(Callable<T> callable) { this.callable = callable; }
   ...
   */
  public T send() throws Exception { return callable.call(); }
   ...
   */
  public CompletableFuture<T> sendAsync() { return Async.run(this::send); }
   ...
   * @return an flowable
   */
  public Flowable<T> flowable() { return Flowable.fromCallable(this::send); }
}
