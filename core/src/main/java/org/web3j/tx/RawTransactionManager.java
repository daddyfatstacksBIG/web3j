 ...
 *
 * <p>This transaction manager provides support for specifying the chain id for
 * transactions as per <a
 * href="https://github.com/ethereum/EIPs/issues/155">EIP155</a>, as well as for
 * locally signing RawTransaction instances without broadcasting them.
 */
public class RawTransactionManager extends TransactionManager {
  ...
  public TxHashVerifier getTxHashVerifier() { return txHashVerifier; }
  ...
  sendTransaction(BigInteger gasPrice, BigInteger gasLimit, String to,
