...
/**
 * Abstraction for managing how we wait for transaction receipts to be
...
public abstract class TransactionReceiptProcessor {
  ...
  public TransactionReceiptProcessor(Web3j web3j) { this.web3j = web3j; }
  ...
  Optional<? extends TransactionReceipt>
