 ...
 *
 * <p><b>Note</b>: accounts must be unlocked on the node for transactions to be
 * successful.
 */
public class ClientTransactionManager extends TransactionManager {
  ...
  public ClientTransactionManager(Web3j web3j, String fromAddress, int attempts,
                                  int sleepDuration) {
  ...
  sendTransaction(BigInteger gasPrice, BigInteger gasLimit, String to,
    ...
    Transaction transaction = new Transaction(getFromAddress(), null, gasPrice,
  ...
  sendTransactionEIP1559(BigInteger gasPremium, BigInteger feeCap,
    ...
    Transaction transaction =
        new Transaction(getFromAddress(), null, null, gasLimit, to, value, data,
                        gasPremium, feeCap);
