...
/**
 * Simple RawTransactionManager derivative that manages nonces to facilitate
...
public class FastRawTransactionManager extends RawTransactionManager {
  ...
  public BigInteger getCurrentNonce() { return nonce; }

  public synchronized void resetNonce() throws IOException {
    nonce = super.getNonce();
  }

  public synchronized void setNonce(BigInteger value) { nonce = value; }
}
