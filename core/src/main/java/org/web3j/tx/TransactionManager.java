...
public abstract class TransactionManager {
  ...
  protected TransactionManager(Web3j web3j, int attempts, long sleepDuration,
                               String fromAddress) {
    this(new PollingTransactionReceiptProcessor(web3j, sleepDuration, attempts),
         fromAddress);
  }
  ...
  protected TransactionReceipt executeTransactionEIP1559(
    ...
    return executeTransactionEIP1559(gasPremium, feeCap, gasLimit, to, data,
                                     value, false);
  }

  protected TransactionReceipt
  executeTransactionEIP1559(BigInteger gasPremium, BigInteger feeCap,
                            BigInteger gasLimit, String to, String data,
                            BigInteger value, boolean constructor)
      throws IOException, TransactionException {

    EthSendTransaction ethSendTransaction = sendTransactionEIP1559(
        gasPremium, feeCap, gasLimit, to, data, value, constructor);
    return processResponse(ethSendTransaction);
  }
  ...
  sendTransactionEIP1559(BigInteger gasPremium, BigInteger feeCap,
                         BigInteger gasLimit, String to, String data,
                         BigInteger value) throws IOException {
    return sendTransactionEIP1559(gasPremium, feeCap, gasLimit, to, data, value,
                                  false);
  }
  ...
  public abstract String sendCall(String to, String data,
                                  DefaultBlockParameter defaultBlockParameter)
      throws IOException;

  public abstract EthGetCode
  getCode(String contractAddress, DefaultBlockParameter defaultBlockParameter)
      throws IOException;
