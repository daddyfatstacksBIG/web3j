...
public class Transfer extends ManagedTransaction {
   ...
   * is strongly recommended via {@link Transfer#sendFunds(String, BigDecimal,
   * Convert.Unit)}.
   *
  ...
  private TransactionReceipt send(String toAddress, BigDecimal value,
                                  Convert.Unit unit, BigInteger gasPrice,
                                  BigInteger gasLimit)
      throws IOException, InterruptedException, TransactionException {
  ...
  public static RemoteCall<TransactionReceipt>
  sendFunds(Web3j web3j, Credentials credentials, String toAddress,
  ...
  sendFunds(String toAddress, BigDecimal value, Convert.Unit unit) {
  ...
  sendFunds(String toAddress, BigDecimal value, Convert.Unit unit,
    ...
    return new RemoteCall<>(
        () -> send(toAddress, value, unit, gasPrice, gasLimit));
  }

  public static RemoteCall<TransactionReceipt>
  sendFundsEIP1559(Web3j web3j, Credentials credentials, String toAddress,
                   BigDecimal value, Convert.Unit unit, BigInteger gasLimit,
    ...
    return new RemoteCall<>(()
                                -> new Transfer(web3j, transactionManager)
                                       .sendEIP1559(toAddress, value, unit,
                                                    gasLimit, gasPremium,
                                                    feeCap));
  }

  private TransactionReceipt
  sendEIP1559(String toAddress, BigDecimal value, Convert.Unit unit,
              BigInteger gasLimit, BigInteger gasPremium, BigInteger feeCap)
      throws IOException, InterruptedException, TransactionException {
    ...
    String resolvedAddress = ensResolver.resolve(toAddress);
    return sendEIP1559(resolvedAddress, "", weiValue.toBigIntegerExact(),
                       gasLimit, gasPremium, feeCap);
  }
}
