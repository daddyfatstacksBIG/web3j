...
public class Utils {
  ...
  static <T extends Type, U extends Type> String
  getParameterizedTypeName(TypeReference<T> typeReference, Class<?> type) {

    try {
      if (type.equals(DynamicArray.class)) {
        Class<U> parameterizedType =
        ...
        throw new UnsupportedOperationException("Invalid type provided " +
                                                type.getName());
      }
    } catch (ClassNotFoundException e) {
      throw new UnsupportedOperationException(
  ...
  @SuppressWarnings("unchecked")
  public static List<TypeReference<Type>>
  ...
  public static <T, R extends Type<T>, E extends Type<T>> List<E>
  typeMap(List<List<T>> input, Class<E> outerDestType, Class<R> innerType) {
  ...
  public static <T, R extends Type<T>> List<R> typeMap(List<T> input,
                                                       Class<R> destType)
