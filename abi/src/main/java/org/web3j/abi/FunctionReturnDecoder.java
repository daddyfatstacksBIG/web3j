 ...
 * FunctionReturnDecoderProvider} SPI is found, in which case the first
 * implementation found will be used.
 *
...
public abstract class FunctionReturnDecoder {
   ...
   * @return {@link List} of values returned by function, {@link
   *     Collections#emptyList()} if invalid response
   */
  public static List<Type> decode(String rawInput,
   ...
   * are individually encoded, unlike non-indexed parameters which are encoded
   * as per ABI-encoded function parameters and return values.
   *
   * <p>If any of the following types are indexed, the Keccak-256 hashes of the
   * values are returned instead. These are returned as a bytes32 value.
   *
   * <ul>
   *   <li>Arrays
   *   <li>Strings
   ...
   *
   * <p>See the <a
   * href="http://solidity.readthedocs.io/en/latest/contracts.html#events">Solidity
   ...
   */
  public static <T extends Type>
      Type decodeIndexedValue(String rawInput, TypeReference<T> typeReference) {
  ...
  protected abstract <T extends Type> Type
  decodeEventParameter(String rawInput, TypeReference<T> typeReference);
