...
/**
 * Maps Solidity types to web3j data types, allowing to use Java primitive types
 * for numbers. The used primitive type is the smallest that can hold a Solidity
 * value for a specific bit length, e.g. {@link java.lang.Short} for
 * <code>int8</code>, <code>int16</code> and <code>uint8</code>;
 * {@link java.lang.Integer} for <code>int24</code>, <code>int32</code>,
 * <code>uint16</code> and <code>uint24</code>, etc.
 */
public final class AbiTypes {
  private AbiTypes() {}

  /**
   * Returns the web3j data type for the given type, without using primitive
   * types.
   *
