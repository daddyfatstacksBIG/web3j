...
/**
 * Delegates to {@link DefaultFunctionEncoder} unless a {@link
 * FunctionEncoderProvider} SPI is found, in which case the first implementation
 * found will be used.
 *
...
public abstract class FunctionEncoder {
  ...
  makeFunction(String fnname, List<String> solidityInputTypes,
  ...
  protected static String buildMethodSignature(final String methodName,
