...
public class DefaultFunctionReturnDecoder extends FunctionReturnDecoder {
  ...
  private static List<Type> build(String input,
                                  List<TypeReference<Type>> outputParameters) {
  ...
  private static <T extends Type> int getDataOffset(String input, int offset,
                                                    Class<T> type) {
