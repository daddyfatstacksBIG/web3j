...
public class UtilsTest {
  ...
  public void testTypeMap() {
    ...
    assertEquals(typeMap(input, Uint256.class),
                 (Arrays.asList(new Uint256(BigInteger.ZERO),
  ...
  public void testTypeMapNested() {
    ...
    List<StaticArray2> actual =
        typeMap(input, StaticArray2.class, Uint256.class);
  ...
  public void testTypeMapEmpty() {
    assertEquals(typeMap(new ArrayList<>(), Uint256.class),
