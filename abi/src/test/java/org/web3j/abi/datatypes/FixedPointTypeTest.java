...
public class FixedPointTypeTest {
  ...
  public void testConvert() {
    assertEquals(FixedPointType.convert(BigInteger.valueOf(0x2),
                                        BigInteger.valueOf(0x2)),
                 (new BigInteger("220000000000000000000000000000000", 16)));

    assertEquals(FixedPointType.convert(BigInteger.valueOf(0x8),
                                        BigInteger.valueOf(0x8)),
                 (new BigInteger("880000000000000000000000000000000", 16)));

    assertEquals(FixedPointType.convert(BigInteger.valueOf(0xAAFF),
