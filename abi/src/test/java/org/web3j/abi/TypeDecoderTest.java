...
public class TypeDecoderTest {
  ...
  */
  ...
  public void testAddress() throws Exception {
    ...
    assertThat(TypeDecoder.instantiateType(
                   "address", "0xbe5422d15f39373eb0a97ff8c10fbd0e40e29338"),
               is(new Address("0xbe5422d15f39373eb0a97ff8c10fbd0e40e29338")));

    assertThat(TypeDecoder.instantiateType("address", BigInteger.ONE),
  ...
  public void testStaticArray() throws Exception {
    ...
    StaticArray2 arr = (StaticArray2)TypeDecoder.instantiateType(
        "uint256[2]", new long[] {10, Long.MAX_VALUE});
    assert (arr instanceof StaticArray2);

    assertThat(arr.getValue().get(0), is(new Uint256(BigInteger.TEN)));

    assertThat(arr.getValue().get(1),
               is(new Uint256(BigInteger.valueOf(Long.MAX_VALUE))));
  }
  ...
  public void testDynamicArray() throws Exception {
    ...
    DynamicArray arr = (DynamicArray)TypeDecoder.instantiateType(
  ...
  public void multiDimArrays() throws Exception {
    ...
    assertThat(TypeDecoder.instantiateType("bytes", bytes1d),
               is(new DynamicBytes(bytes1d)));

    StaticArray3<DynamicArray<Uint256>> twoDim =
        (StaticArray3<DynamicArray<Uint256>>)TypeDecoder.instantiateType(
            "uint256[][3]", bytes2d);
