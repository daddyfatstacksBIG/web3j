...
public class FunctionReturnDecoderTest {
  ...
  public void testSimpleFunctionDecode() {
    Function function =
        new Function("test", Collections.<Type>emptyList(),
  ...
  public void testMultipleResultFunctionDecode() {
    ...
    assertEquals(
        FunctionReturnDecoder.decode(
            ...
            function.getOutputParameters()),
        (Arrays.asList(new Uint(BigInteger.valueOf(55)),
  ...
  public void testDecodeMultipleStringValues() {
    Function function =
        new Function("function", Collections.<Type>emptyList(),
    ...
    assertEquals(
        FunctionReturnDecoder.decode(
            ...
            function.getOutputParameters()),
        (Arrays.asList(new Utf8String("def1"), new Utf8String("ghi1"),
  ...
  public void testDecodeStaticArrayValue() {
    ...
    outputParameters.add(
        (TypeReference) new TypeReference
            .StaticArrayTypeReference<StaticArray<Uint256>>(2) {});
  ...
  public void testEmptyResultFunctionDecode() {
    Function function =
        new Function("test", Collections.emptyList(),
                     Collections.singletonList(new TypeReference<Uint>() {}));
  ...
  public void testDecodeIndexedUint256Value() {
    ...
    assertEquals(FunctionReturnDecoder.decodeIndexedValue(
                     encoded, new TypeReference<Uint256>() {}),
                 (value));
  }
  ...
  public void testDecodeIndexedStringValue() {
    ...
    assertEquals(FunctionReturnDecoder.decodeIndexedValue(
                     hash, new TypeReference<Utf8String>() {}),
  ...
  public void testDecodeIndexedBytes32Value() {
    ...
    assertEquals(FunctionReturnDecoder.decodeIndexedValue(
                     rawInput, new TypeReference<Bytes32>() {}),
  ...
  public void testDecodeIndexedBytes16Value() {
    ...
    byte[] rawInputBytes =
        Numeric.hexStringToByteArray(rawInput.substring(0, 34));

    assertEquals(FunctionReturnDecoder.decodeIndexedValue(
                     rawInput, new TypeReference<Bytes16>() {}),
