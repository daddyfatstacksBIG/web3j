...
public class DefaultFunctionEncoderTest {
  ...
  public void testBuildMethodId() {
    assertThat(DefaultFunctionEncoder.buildMethodId("baz(uint32,bool)"),
               is("0xcdcd77c0"));
  }

  @Test
  public void testBuildMessageSignature() {
    assertThat(DefaultFunctionEncoder.buildMethodSignature(
  ...
  public void testEncodeConstructorEmpty() {
    assertThat(FunctionEncoder.encodeConstructor(Collections.emptyList()),
               is(""));
  }
