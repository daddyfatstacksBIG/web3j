...
public class ResponseTest extends ResponseTester {
  ...
  public void testPersonalEcRecover() {
    ...
    PersonalEcRecover personalEcRecover =
        deserialiseResponse(PersonalEcRecover.class);
    assertEquals(personalEcRecover.getRecoverAccountId(),
  ...
  public void testPersonalImportRawKey() {
    ...
    PersonalImportRawKey personalImportRawKey =
        deserialiseResponse(PersonalImportRawKey.class);
    assertEquals(personalImportRawKey.getAccountId(),
                 ("0xadfc0262bbed8c1f4bd24a4a763ac616803a8c54"));
  }
}
