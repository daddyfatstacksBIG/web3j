...
public class VMTrace {
  ...
  public static class VMOperation {
    ...
    public static class Ex {
      ...
      public static class Mem {
        ...
        public BigInteger getOff() { return off; }

        public void setOff(BigInteger off) { this.off = off; }
      ...
      public List<String> getPush() { return push; }

      public void setPush(List<String> push) { this.push = push; }

      public Store getStore() { return store; }

      public void setStore(Store store) { this.store = store; }

      public BigInteger getUsed() { return used; }

      public void setUsed(BigInteger used) { this.used = used; }
      ...
      public String toString() {
        return "Ex{"
            + "mem=" + getMem() + ", push=" + getPush() +
            ", store=" + getStore() + ", used=" + getUsed() + '}';
      }
    }
    ...
    public VMTrace getSub() { return sub; }

    public void setSub(VMTrace sub) { this.sub = sub; }

    public BigInteger getCost() { return cost; }

    public void setCost(BigInteger cost) { this.cost = cost; }

    public Ex getEx() { return ex; }

    public void setEx(Ex ex) { this.ex = ex; }

    public BigInteger getPc() { return pc; }

    public void setPc(BigInteger pc) { this.pc = pc; }
    ...
    public boolean equals(Object o) {
      ...
      if (getSub() != null ? !getSub().equals(that.getSub())
                           : that.getSub() != null) {
        return false;
      }
      if (getCost() != null ? !getCost().equals(that.getCost())
                            : that.getCost() != null) {
        return false;
      }
      if (getEx() != null ? !getEx().equals(that.getEx())
                          : that.getEx() != null) {
        return false;
      }
      return getPc() != null ? getPc().equals(that.getPc())
                             : that.getPc() == null;
    }
    ...
    public String toString() {
      return "VMOperation{"
          + "sub=" + getSub() + ", cost=" + getCost() + ", ex=" + getEx() +
          ", pc=" + getPc() + '}';
    }
  }
  ...
  public List<VMOperation> getOps() { return ops; }

  public void setOps(List<VMOperation> ops) { this.ops = ops; }
  ...
  public boolean equals(Object o) {
    ...
    if (getCode() != null ? !getCode().equals(vmTrace.getCode())
                          : vmTrace.getCode() != null) {
      return false;
    }
    return getOps() != null ? getOps().equals(vmTrace.getOps())
                            : vmTrace.getOps() == null;
  }
