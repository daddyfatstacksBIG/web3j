...
public class FullTraceInfo {
  ...
  public Map<String, StateDiff> getStateDiff() { return stateDiff; }

  public void setStateDiff(Map<String, StateDiff> stateDiff) {
    this.stateDiff = stateDiff;
  }

  public List<Trace> getTrace() { return trace; }

  public void setTrace(List<Trace> trace) { this.trace = trace; }

  public VMTrace getVmTrace() { return vmTrace; }

  public void setVmTrace(VMTrace vmTrace) { this.vmTrace = vmTrace; }
  ...
  public int hashCode() {
    ...
    result =
        31 * result + (getStateDiff() != null ? getStateDiff().hashCode() : 0);
