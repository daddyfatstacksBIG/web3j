...
public class RequestTest extends RequestTester {
  ...
  public void testParityChangePassword() throws Exception {
    ...
    web3j
        .parityChangePassword("0x407d73d8a49eeb85d32cf465507dd71d507100c1",
                              "hunter2", "bazqux5")
        .send();
  ...
  public void testParityDeriveAddressHash() throws Exception {
    ...
    web3j
        .parityDeriveAddressHash("0x407d73d8a49eeb85d32cf465507dd71d507100c1",
                                 "hunter2", hashType, false)
        .send();
  ...
  public void testParityDeriveAddressIndex() throws Exception {
    ...
    web3j
        .parityDeriveAddressIndex("0x407d73d8a49eeb85d32cf465507dd71d507100c1",
                                  "hunter2", indexType, false)
        .send();
  ...
  public void testParityExportAccount() throws Exception {
    web3j
        .parityExportAccount("0x407d73d8a49eeb85d32cf465507dd71d507100c1",
                             "hunter2")
        .send();
  ...
  public void testParityKillAccount() throws Exception {
    web3j
        .parityKillAccount("0x407d73d8a49eeb85d32cf465507dd71d507100c1",
                           "hunter2")
        .send();
  ...
  @Test
  public void testParityListAccountsNoAccountOffsetNoBlockTag()
      throws Exception {
  ...
  @Test
  public void testParityListAccountsNoAccountOffsetWithBlockTag()
      throws Exception {
    BigInteger maxQuantityReturned = BigInteger.valueOf(100);
  ...
  @Test
  public void testParityListAccountsWithAccountOffsetWithBlockTag()
      throws Exception {
    BigInteger maxQuantityReturned = BigInteger.valueOf(100);
    DefaultBlockParameter blockParameter = DefaultBlockParameterName.LATEST;
    web3j
        .parityListAccounts(maxQuantityReturned,
  ...
  @Test
  public void testParityListAccountsWithAccountOffsetNoBlockTag()
      throws Exception {
    BigInteger maxQuantityReturned = BigInteger.valueOf(100);
    web3j
        .parityListAccounts(maxQuantityReturned,
                            "0x407d73d8a49eeb85d32cf465507dd71d507100c1", null)
        .send();
  ...
  public void testParityRemoveAddress() throws Exception {
    web3j.parityRemoveAddress("0x407d73d8a49eeb85d32cf465507dd71d507100c1")
        .send();
  ...
  public void testParitySetAccountMeta() throws Exception {
    ...
    meta.put("foo", "bar");
    web3j
        .paritySetAccountMeta("0xfc390d8a8ddb591b010fda52f4db4945742c3809",
                              meta)
        .send();
  ...
  public void testParitySetAccountName() throws Exception {
    web3j
        .paritySetAccountName("0xfc390d8a8ddb591b010fda52f4db4945742c3809",
                              "Savings")
        .send();
  ...
  public void testParitySetDappDefaultAddress() throws Exception {
    web3j
        .paritySetDappDefaultAddress(
            "web", "0x407d73d8a49eeb85d32cf465507dd71d507100c1")
        .send();
  ...
  public void testParityTestPassword() throws Exception {
    web3j
        .parityTestPassword("0x407d73d8a49eeb85d32cf465507dd71d507100c1",
                            "hunter2")
        .send();
  ...
  public void testParitySignMessage() throws Exception {
    ...
    web3j
        .paritySignMessage(
            "0xc171033d5cbff7175f29dfd3a63dda3d6f8f385e", "password1",
  ...
  public void testTraceCall() throws Exception {
    Transaction transaction = Transaction.createFunctionCallTransaction(
        "0xc171033d5cbff7175f29dfd3a63dda3d6f8f385e", BigInteger.ONE,
        Numeric.toBigInt("0x9184e72a000"), Numeric.toBigInt("0x76c0"),
        "0xb60e8dd61c5d32be8058bb8eb970870f07233155",
        Numeric.toBigInt("0x9184e72a"),
        "0xd46e8dd67c5d32be8d46e8dd67c5d32be8058bb8eb"
            + "970870f072445675058bb8eb970870f072445675");
    web3j
        .traceCall(transaction, Arrays.asList("trace", "vmTrace", "stateDiff"),
  ...
  public void testTraceFilter() throws Exception {
    web3j
        .traceFilter(
            new TraceFilter(DefaultBlockParameterName.EARLIEST,
                            DefaultBlockParameterName.LATEST,
  ...
  public void testTraceGet() throws Exception {
    web3j
        .traceGet(
            "0x090a4bbdeb57f15fe252cccc924255855eda45a2d8f65b12ec81f03e2cc33249",
            Arrays.asList(BigInteger.valueOf(2), BigInteger.ZERO,
                          BigInteger.ZERO))
        .send();
