...
public class EqualsVerifierParityResponseTest {
  ...
  public void testVMTrace() {
    VMTrace.VMOperation op1 =
        new VMTrace.VMOperation(null, BigInteger.ZERO, null, null);
    VMTrace.VMOperation op2 =
        new VMTrace.VMOperation(null, BigInteger.ONE, null, null);
