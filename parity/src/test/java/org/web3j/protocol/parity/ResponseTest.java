...
public class ResponseTest extends ResponseTester {
  ...
  public void testParityAllAccountsInfo() {
    ...
    accountsInfoMap.put("0x00a289b43e1e4825dbedf2a78ba60a640634dc40",
                        new ParityAllAccountsInfo.AccountsInfo(
                            Collections.<String, Object>emptyMap(), "Savings",
    ...
    assertThat(parityAllAccountsInfo.getAccountsInfo(),
               equalTo(accountsInfoMap));
  }
  ...
  public void testParityDefaultAddressResponse() {
    ...
    assertThat(parityDefaultAddressesResponse.getAddress(),
  ...
  public void testParityDeriveAddress() {
    ...
    ParityDeriveAddress parityDeriveAddress =
        deserialiseResponse(ParityDeriveAddress.class);
    assertThat(parityDeriveAddress.getAddress(),
               is("0x407d73d8a49eeb85d32cf465507dd71d507100c1"));
  }
  ...
  public void testParityExportAccount() {
    ...
    crypto.setCiphertext(
        "df27e3db64aa18d984b6439443f73660643c2d119a6f0fa2fa9a6456fc802d75");
    ...
    WalletFile.Aes128CtrKdfParams kdfParams =
        new WalletFile.Aes128CtrKdfParams();
    kdfParams.setC(10240);
    kdfParams.setPrf("hmac-sha256");
    kdfParams.setDklen(32);
    kdfParams.setSalt(
        "ddc325335cda5567a1719313e73b4842511f3e4a837c9658eeb78e51ebe8c815");
    crypto.setKdfparams(kdfParams);

    crypto.setMac(
        "3dc888ae79cbb226ff9c455669f6cf2d79be72120f2298f6cb0d444fddc0aa3d");
    walletFile.setCrypto(crypto);
    walletFile.setId("6a186c80-7797-cff2-bc2e-7c1d6a6cc76e");
    walletFile.setVersion(3);

    ParityExportAccount parityExportAccount =
  ...
  public void testParityListRecentDapps() {
    ...
    assertThat(parityListRecentDapps.getDappsIds(),
               equalTo(Arrays.asList("web")));
  }
  ...
  public void testParityFullTraceResponseStateDiff() {
    ...
    ParityFullTraceResponse response =
        deserialiseResponse(ParityFullTraceResponse.class);
    assertNotNull(response);

    Map<String, StateDiff> stateDiffMap = new LinkedHashMap<>();
    stateDiffMap.put(
        "0x00a0a24b9f0e5ec7aa4c7389b8302fd0123194de",
        new StateDiff(new StateDiff.ChangedState("0x2067ee238a4648bed5797",
                                                 "0x2067ee23f5d09db3d0397"),
                      new StateDiff.UnchangedState(),
                      new StateDiff.UnchangedState(), new HashMap<>()));
    stateDiffMap.put(
        "0x14772e4f805b4dd2e69bd6d3f9b5edf0dfa5385a",
        new StateDiff(new StateDiff.ChangedState("0xf85a746b58c1fee",
                                                 "0xf7eeea1663c73ee"),
                      new StateDiff.UnchangedState(),
  ...
  public void testParityFullTraceResponseTraces() {
    ...
    trace1.setBlockHash(
        "0xf831abfdc67fb2ea3d16b6510b8e37d3d3e52ce3c25ed345053cb9503a430dd8");
    ...
    trace3.setBlockHash(
        "0xf263b9364434a781057c467004e8d398d915529bdffa6f600d6d17fe733d3210");
    ...
    trace4.setBlockHash(
        "0x8d9aff92ab07598b65ca3457dc68ee66de48ea0e1d4b0a658b6e39977b2a8542");
    ...
    List<org.web3j.protocol.parity.methods.response.Trace> traces =
        new ArrayList<>();
    traces.add(trace1);
    traces.add(trace2);
    traces.add(trace3);
  ...
  public void testParityFullTraceResponseVMTrace() {
    ...
    VMTrace.VMOperation subOperation = new VMTrace.VMOperation(
        null, BigInteger.valueOf(3),
        new VMTrace.VMOperation.Ex(null, Collections.singletonList("0x60"),
                                   null, BigInteger.valueOf(5753235)),
        BigInteger.ZERO);

    VMTrace.VMOperation operation2 = new VMTrace.VMOperation(
        new VMTrace("0x606060405236156100b75763ffffffff",
                    Collections.singletonList(subOperation)),
        BigInteger.valueOf(9700),
        new VMTrace.VMOperation.Ex(
            new VMTrace.VMOperation.Ex.Mem("0x", BigInteger.valueOf(96)),
            Collections.singletonList("0x1"), null, BigInteger.valueOf(317494)),
        BigInteger.valueOf(337));

    VMTrace trace = new VMTrace("0x6060604052361561004a576000357c01",
