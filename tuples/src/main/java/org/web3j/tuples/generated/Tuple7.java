...
public final class Tuple7<T1, T2, T3, T4, T5, T6, T7> implements Tuple {
  ...
  public boolean equals(Object o) {
    ...
    if (value1 != null ? !value1.equals(tuple7.value1)
                       : tuple7.value1 != null) {
      return false;
    }
    if (value2 != null ? !value2.equals(tuple7.value2)
                       : tuple7.value2 != null) {
      return false;
    }
    if (value3 != null ? !value3.equals(tuple7.value3)
                       : tuple7.value3 != null) {
      return false;
    }
    if (value4 != null ? !value4.equals(tuple7.value4)
                       : tuple7.value4 != null) {
      return false;
    }
    if (value5 != null ? !value5.equals(tuple7.value5)
                       : tuple7.value5 != null) {
      return false;
    }
    if (value6 != null ? !value6.equals(tuple7.value6)
                       : tuple7.value6 != null) {
      return false;
    }
    return value7 != null ? value7.equals(tuple7.value7)
                          : tuple7.value7 == null;
  }
