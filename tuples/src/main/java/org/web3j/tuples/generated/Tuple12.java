...
public final class Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>
  ...
  public Tuple12(T1 value1, T2 value2, T3 value3, T4 value4, T5 value5,
  ...
  public boolean equals(Object o) {
    ...
    Tuple12<?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?> tuple12 =
        (Tuple12<?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?>)o;
    if (value1 != null ? !value1.equals(tuple12.value1)
                       : tuple12.value1 != null) {
      return false;
    }
    if (value2 != null ? !value2.equals(tuple12.value2)
                       : tuple12.value2 != null) {
      return false;
    }
    if (value3 != null ? !value3.equals(tuple12.value3)
                       : tuple12.value3 != null) {
      return false;
    }
    if (value4 != null ? !value4.equals(tuple12.value4)
                       : tuple12.value4 != null) {
      return false;
    }
    if (value5 != null ? !value5.equals(tuple12.value5)
                       : tuple12.value5 != null) {
      return false;
    }
    if (value6 != null ? !value6.equals(tuple12.value6)
                       : tuple12.value6 != null) {
      return false;
    }
    if (value7 != null ? !value7.equals(tuple12.value7)
                       : tuple12.value7 != null) {
      return false;
    }
    if (value8 != null ? !value8.equals(tuple12.value8)
                       : tuple12.value8 != null) {
      return false;
    }
    if (value9 != null ? !value9.equals(tuple12.value9)
                       : tuple12.value9 != null) {
      return false;
    }
    if (value10 != null ? !value10.equals(tuple12.value10)
                        : tuple12.value10 != null) {
      return false;
    }
    if (value11 != null ? !value11.equals(tuple12.value11)
                        : tuple12.value11 != null) {
      return false;
    }
    return value12 != null ? value12.equals(tuple12.value12)
                           : tuple12.value12 == null;
  }
