...
public final class Tuple6<T1, T2, T3, T4, T5, T6> implements Tuple {
  ...
  public Tuple6(T1 value1, T2 value2, T3 value3, T4 value4, T5 value5,
                T6 value6) {
    this.value1 = value1;
    this.value2 = value2;
    this.value3 = value3;
  ...
  public boolean equals(Object o) {
    ...
    if (value1 != null ? !value1.equals(tuple6.value1)
                       : tuple6.value1 != null) {
      return false;
    }
    if (value2 != null ? !value2.equals(tuple6.value2)
                       : tuple6.value2 != null) {
      return false;
    }
    if (value3 != null ? !value3.equals(tuple6.value3)
                       : tuple6.value3 != null) {
      return false;
    }
    if (value4 != null ? !value4.equals(tuple6.value4)
                       : tuple6.value4 != null) {
      return false;
    }
    if (value5 != null ? !value5.equals(tuple6.value5)
                       : tuple6.value5 != null) {
      return false;
    }
    return value6 != null ? value6.equals(tuple6.value6)
                          : tuple6.value6 == null;
  }
