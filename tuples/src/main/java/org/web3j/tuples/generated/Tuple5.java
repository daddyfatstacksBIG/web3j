...
public final class Tuple5<T1, T2, T3, T4, T5> implements Tuple {
  ...
  public boolean equals(Object o) {
    ...
    if (value1 != null ? !value1.equals(tuple5.value1)
                       : tuple5.value1 != null) {
      return false;
    }
    if (value2 != null ? !value2.equals(tuple5.value2)
                       : tuple5.value2 != null) {
      return false;
    }
    if (value3 != null ? !value3.equals(tuple5.value3)
                       : tuple5.value3 != null) {
      return false;
    }
    if (value4 != null ? !value4.equals(tuple5.value4)
                       : tuple5.value4 != null) {
      return false;
    }
    return value5 != null ? value5.equals(tuple5.value5)
                          : tuple5.value5 == null;
  }
