...
public final class Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9> implements Tuple {
  ...
  public Tuple9(T1 value1, T2 value2, T3 value3, T4 value4, T5 value5,
  ...
  public boolean equals(Object o) {
    ...
    Tuple9<?, ?, ?, ?, ?, ?, ?, ?, ?> tuple9 =
        (Tuple9<?, ?, ?, ?, ?, ?, ?, ?, ?>)o;
    if (value1 != null ? !value1.equals(tuple9.value1)
                       : tuple9.value1 != null) {
      return false;
    }
    if (value2 != null ? !value2.equals(tuple9.value2)
                       : tuple9.value2 != null) {
      return false;
    }
    if (value3 != null ? !value3.equals(tuple9.value3)
                       : tuple9.value3 != null) {
      return false;
    }
    if (value4 != null ? !value4.equals(tuple9.value4)
                       : tuple9.value4 != null) {
      return false;
    }
    if (value5 != null ? !value5.equals(tuple9.value5)
                       : tuple9.value5 != null) {
      return false;
    }
    if (value6 != null ? !value6.equals(tuple9.value6)
                       : tuple9.value6 != null) {
      return false;
    }
    if (value7 != null ? !value7.equals(tuple9.value7)
                       : tuple9.value7 != null) {
      return false;
    }
    if (value8 != null ? !value8.equals(tuple9.value8)
                       : tuple9.value8 != null) {
      return false;
    }
    return value9 != null ? value9.equals(tuple9.value9)
                          : tuple9.value9 == null;
  }
