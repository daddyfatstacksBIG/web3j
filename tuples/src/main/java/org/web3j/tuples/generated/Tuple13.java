...
public final class Tuple13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12,
  ...
  public Tuple13(T1 value1, T2 value2, T3 value3, T4 value4, T5 value5,
  ...
  public boolean equals(Object o) {
    ...
    Tuple13<?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?> tuple13 =
        (Tuple13<?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?>)o;
    if (value1 != null ? !value1.equals(tuple13.value1)
                       : tuple13.value1 != null) {
      return false;
    }
    if (value2 != null ? !value2.equals(tuple13.value2)
                       : tuple13.value2 != null) {
      return false;
    }
    if (value3 != null ? !value3.equals(tuple13.value3)
                       : tuple13.value3 != null) {
      return false;
    }
    if (value4 != null ? !value4.equals(tuple13.value4)
                       : tuple13.value4 != null) {
      return false;
    }
    if (value5 != null ? !value5.equals(tuple13.value5)
                       : tuple13.value5 != null) {
      return false;
    }
    if (value6 != null ? !value6.equals(tuple13.value6)
                       : tuple13.value6 != null) {
      return false;
    }
    if (value7 != null ? !value7.equals(tuple13.value7)
                       : tuple13.value7 != null) {
      return false;
    }
    if (value8 != null ? !value8.equals(tuple13.value8)
                       : tuple13.value8 != null) {
      return false;
    }
    if (value9 != null ? !value9.equals(tuple13.value9)
                       : tuple13.value9 != null) {
      return false;
    }
    if (value10 != null ? !value10.equals(tuple13.value10)
                        : tuple13.value10 != null) {
      return false;
    }
    if (value11 != null ? !value11.equals(tuple13.value11)
                        : tuple13.value11 != null) {
      return false;
    }
    if (value12 != null ? !value12.equals(tuple13.value12)
                        : tuple13.value12 != null) {
      return false;
    }
    return value13 != null ? value13.equals(tuple13.value13)
                           : tuple13.value13 == null;
  }
