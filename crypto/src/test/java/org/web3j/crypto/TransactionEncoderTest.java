...
public class TransactionEncoderTest {
  ...
  public void testEtherTransactionAsRlpValues() {
    ...
    assertEquals(rlpStrings.get(3),
                 (RlpString.create(new BigInteger("add5355", 16))));
  }
  ...
  public void testEip1559Transaction() {
    ...
    Credentials credentials = Credentials.create(
        "0x4646464646464646464646464646464646464646464646464646464646464646");
    assertArrayEquals(
        TransactionEncoder.signMessage(createEip1559RawTransaction(), (byte)1,
                                       credentials),
        (Numeric.hexStringToByteArray(
  ...
  private static RawTransaction createEip1559RawTransaction() {
    return RawTransaction.createEtherTransaction(
        BigInteger.valueOf(0), BigInteger.valueOf(30000),
        "0x627306090abaB3A6e1400e9345bC60c78a8BEf57", BigInteger.valueOf(123),
        BigInteger.valueOf(5678), BigInteger.valueOf(1100000));
  }
}
