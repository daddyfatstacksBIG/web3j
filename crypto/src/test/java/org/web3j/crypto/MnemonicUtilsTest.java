...
public class MnemonicUtilsTest {
   ...
   *
   * @return Collection of test vectors in which each vector is an array
   *     containing initial entropy, expected mnemonic and expected seed.
  ...
  /**
   * The initial entropy for the current test vector. This entropy should be
   * used to generate mnemonic and seed.
   */
  ...
  /**
   * Expected seed based on the calculated {@link #mnemonic} and default
   * passphrase.
   */
  private byte[] seed;

  public MnemonicUtilsTest(String initialEntropy, String mnemonic,
                           String seed) {
