...
public class Credentials {
  ...
  public ECKeyPair getEcKeyPair() { return ecKeyPair; }
  ...
  public static Credentials create(String privateKey, String publicKey) {
    return create(new ECKeyPair(Numeric.toBigInt(privateKey),
                                Numeric.toBigInt(publicKey)));
  }
  ...
  public boolean equals(Object o) {
    ...
    if (ecKeyPair != null ? !ecKeyPair.equals(that.ecKeyPair)
                          : that.ecKeyPair != null) {
      return false;
    }
