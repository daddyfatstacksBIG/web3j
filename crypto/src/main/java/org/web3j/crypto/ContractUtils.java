...
public class ContractUtils {
  ...
  /**
   * Generate a smart contract address. This enables you to identify what
   * address a smart contract will be deployed to on the network.
   *
  ...
  public static String generateContractAddress(String address,
                                               BigInteger nonce) {
    byte[] result =
        generateContractAddress(Numeric.hexStringToByteArray(address), nonce);
