 ...
 *
 * <p>This is to address issues with SecureRandom on Android. For more
 * information, refer to the following <a
 * href="https://github.com/web3j/web3j/issues/146">issue</a>.
 */
final class SecureRandomUtils {
  ...
  static SecureRandom secureRandom() { return SECURE_RANDOM; }
  ...
  static boolean isAndroidRuntime() {
    if (isAndroid == -1) {
      ...
      isAndroid =
          (runtime != null && runtime.equals("Android Runtime")) ? 1 : 0;
    }
    return isAndroid == 1;
  }
