...
public class StructuredData {
  static class Entry {
    ...
    @JsonCreator
    public Entry(@JsonProperty(value = "name") String name,
  ...
  static class EIP712Domain {
    ...
    @JsonCreator
    public EIP712Domain(@JsonProperty(value = "name") String name,
                        @JsonProperty(value = "version") String version,
                        @JsonProperty(value = "chainId") Uint256 chainId,
                        @JsonProperty(value = "verifyingContract")
    ...
    public Uint256 getChainId() { return chainId; }
  ...
  static class EIP712Message {
    ...
    public HashMap<String, List<Entry>> getTypes() { return types; }
    ...
    public String toString() {
      return "EIP712Message{"
          + "primaryType='" + this.primaryType + '\'' + ", message='" +
          this.message + '\'' + '}';
    }
  }
}
