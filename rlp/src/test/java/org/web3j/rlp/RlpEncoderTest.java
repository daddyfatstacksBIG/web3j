...
public class RlpEncoderTest {
  ...
  public void testEncode() {
    assertArrayEquals(RlpEncoder.encode(RlpString.create("dog")),
                      (new byte[] {(byte)0x83, 'd', 'o', 'g'}));

    assertArrayEquals(RlpEncoder.encode(new RlpList(RlpString.create("cat"),
                                                    RlpString.create("dog"))),
                      (new byte[] {(byte)0xc8, (byte)0x83, 'c', 'a', 't',
                                   (byte)0x83, 'd', 'o', 'g'}));

    assertArrayEquals(RlpEncoder.encode(RlpString.create("")),
                      (new byte[] {(byte)0x80}));

    assertArrayEquals(RlpEncoder.encode(RlpString.create(new byte[] {})),
                      (new byte[] {(byte)0x80}));

    assertArrayEquals(RlpEncoder.encode(new RlpList()),
                      (new byte[] {(byte)0xc0}));
    ...
    assertArrayEquals(
        ...
        (new byte[] {(byte)0xc7, (byte)0xc0, (byte)0xc1, (byte)0xc0, (byte)0xc3,
                     (byte)0xc0, (byte)0xc1, (byte)0xc0}));
    ...
    assertArrayEquals(RlpEncoder.encode(RlpString.create(BigInteger.ZERO)),
                      (new byte[] {(byte)0x80}));

    // https://github.com/paritytech/parity-common/blob/master/rlp/tests/tests.rs#L237
    assertArrayEquals(RlpEncoder.encode(RlpString.create(new byte[] {0})),
                      (new byte[] {(byte)0x00}));

    assertArrayEquals(
        RlpEncoder.encode(new RlpList(RlpString.create("zw"),
                                      new RlpList(RlpString.create(4)),
                                      RlpString.create(1))),
        (new byte[] {(byte)0xc6, (byte)0x82, (byte)0x7a, (byte)0x77, (byte)0xc1,
                     (byte)0x04, (byte)0x01}));
    ...
    assertArrayEquals(RlpEncoder.encode(RlpString.create(encodeMe)),
                      (expectedEncoding));
  }
}
