...
public class RlpDecoderTest {
  ...
  /**
   * Examples taken from https://github.com/ethereum/wiki/wiki/RLP#examples. For
  ...
  public void testRLPDecode() {
    ...
    assertEquals(RlpString.create(BigInteger.valueOf(value))
    ...
    assertEquals(RlpDecoder.decode(new byte[] {(byte)0x83, 'd', 'o', 'g'})
                     .getValues()
                     .get(0),
                 (RlpString.create("dog")));

    // The list [ "cat", "dog" ] = [ 0xc8, 0x83, 'c', 'a', 't', 0x83, 'd', 'o',
    // 'g' ]
    RlpList rlpList = (RlpList)RlpDecoder
                          .decode(new byte[] {(byte)0xc8, (byte)0x83, 'c', 'a',
                                              't', (byte)0x83, 'd', 'o', 'g'})
                          .getValues()
                          .get(0);
    ...
    assertEquals(RlpDecoder.decode(new byte[] {(byte)0x80}).getValues().get(0),
                 (RlpString.create("")));
    ...
    // The empty list = [ 0xc0 ]
    assertEquals(RlpDecoder.decode(new byte[] {(byte)0xc0})
                     .getValues()
                     .get(0)
                     .getClass(),
                 (RlpList.class));
    ...
    assertEquals(RlpDecoder.decode(new byte[] {(byte)0x00}).getValues().get(0),
                 (RlpString.create(BigInteger.valueOf(0).byteValue())));

    // The encoded integer 15 ('\x0f') = [ 0x0f ]
    assertEquals(RlpDecoder.decode(new byte[] {(byte)0x0f}).getValues().get(0),
    ...
    // [ [], [[]], [ [], [[]] ] ] = [ 0xc7, 0xc0, 0xc1, 0xc0, 0xc3, 0xc0, 0xc1,
    // 0xc0 ]
    rlpList = RlpDecoder.decode(new byte[] {(byte)0xc7, (byte)0xc0, (byte)0xc1,
                                            (byte)0xc0, (byte)0xc3, (byte)0xc0,
                                            (byte)0xc1, (byte)0xc0});
    ...
    assertEquals(((RlpList)((RlpList)((RlpList)rlpList.getValues().get(0))
                                .getValues()
                                .get(2))
                      .getValues()
                      .get(0))
    ...
    rlpList = RlpDecoder.decode(new byte[] {(byte)0xc6, (byte)0x82, (byte)0x7a,
                                            (byte)0x77, (byte)0xc1, (byte)0x04,
                                            (byte)0x01});
    ...
    assertEquals(((RlpList)rlpList.getValues().get(0)).getValues().get(0),
                 (RlpString.create("zw")));
    ...
    assertEquals(((RlpList)rlpList.getValues().get(0)).getValues().get(2),
                 (RlpString.create(1)));
