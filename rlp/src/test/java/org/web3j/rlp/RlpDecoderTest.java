...
public class RlpDecoderTest {
  ...
  public void testRLPDecode() {
    ...
    assertThat(RlpString.create(BigInteger.valueOf(value))
    ...
    assertThat(RlpDecoder.decode(new byte[] {(byte)0x83, 'd', 'o', 'g'})
                   .getValues()
                   .get(0),
    ...
    assertThat(((RlpList)((RlpList)((RlpList)rlpList.getValues().get(0))
                              .getValues()
                              .get(2))
                    .getValues()
                    .get(0))
