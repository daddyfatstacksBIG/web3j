...
public class BesuSignerMetric {
  ...
  @JsonCreator
  public BesuSignerMetric(@JsonProperty(value = "address") final String address,
                          @JsonProperty(value = "proposedBlockCount")
                          final String proposedBlockCount,
                          @JsonProperty(value = "name")
                          final String lastProposedBlockNumber) {
  ...
  public boolean equals(Object o) {
    ...
    return getAddress().equals(that.getAddress()) &&
        ...
        Objects.equals(getLastProposedBlockNumber(),
                       that.getLastProposedBlockNumber());
  }

  @Override
  public int hashCode() {
    return Objects.hash(getAddress(), getProposedBlockCount(),
                        getLastProposedBlockNumber());
  }
}
