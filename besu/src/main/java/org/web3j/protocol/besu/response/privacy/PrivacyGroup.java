...
public class PrivacyGroup {
  ...
  public enum Type { LEGACY, PANTHEON, ONCHAIN }
  ...
  public List<Base64String> getMembers() { return members; }
  ...
  public boolean equals(Object o) {
    ...
    return getPrivacyGroupId().equals(that.getPrivacyGroupId()) &&
        ...
        getType() == that.getType() && getMembers().equals(that.getMembers());
  }

  @Override
  public int hashCode() {
    return Objects.hash(getPrivacyGroupId(), getName(), getDescription(),
                        getType(), getMembers());
  }
}
