...
public class StructLogs {
  ...
  public StructLogs(int pc, String op, int gas, int gasCost, int depth,
                    List<String> stack, List<String> memory,
  ...
  public void setGasCost(int gasCost) { this.gasCost = gasCost; }

  public void setDepth(int depth) { this.depth = depth; }

  public void setStack(List<String> stack) { this.stack = stack; }

  public void setMemory(List<String> memory) { this.memory = memory; }
  ...
  public List<String> getMemory() { return memory; }

  public Map<BigInteger, String> getStorage() { return storage; }
}
