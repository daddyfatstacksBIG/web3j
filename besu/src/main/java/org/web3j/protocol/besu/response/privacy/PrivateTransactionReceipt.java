...
public class PrivateTransactionReceipt extends TransactionReceipt {
  ...
  public String getPrivateFrom() { return privateFrom; }

  public ArrayList<String> getPrivateFor() { return privateFor; }

  public String getPrivacyGroupId() { return privacyGroupId; }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), contractAddress, from, to, output,
                        logs, commitmentHash, transactionHash, privateFrom,
                        privateFor, privacyGroupId, status, revertReason);
  }
}
