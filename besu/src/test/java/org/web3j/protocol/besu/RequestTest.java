...
public class RequestTest extends RequestTester {
  ...
  public void testIbftGetPendingVotes() throws Exception {
    ...
    verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"ibft_getPendingVotes\","
                 + "\"params\":[],\"id\":1}");
  }
  ...
  public void testPrivGetTransactionCount() throws Exception {
    web3j
        .privGetTransactionCount("0x407d73d8a49eeb85d32cf465507dd71d507100c1",
  ...
  public void testPrivCreatePrivacyGroup() throws Exception {
    web3j.privCreatePrivacyGroup(BASE_64_STRINGS, "testName", "testDesc")
        .send();
  ...
  public void testPrivGetCode() throws Exception {
    web3j
        .privGetCode(MOCK_PRIVACY_GROUP_ID.toString(),
  ...
  public void testPrivCall() throws Exception {
    web3j
        .privCall(MOCK_PRIVACY_GROUP_ID.toString(),
  ...
  public void testPrivUninstallFilter() throws Exception {
    web3j
        .privUninstallFilter(MOCK_PRIVACY_GROUP_ID.toString(),
                             "0x13e9b67497fa859338ecba166752591b")
        .send();
  ...
  public void testPrivGetFilterChanges() throws Exception {
    web3j
        .privGetFilterChanges(MOCK_PRIVACY_GROUP_ID.toString(),
                              "0x13e9b67497fa859338ecba166752591b")
        .send();
  ...
  public void testPrivGetFilterLogs() throws Exception {
    web3j
        .privGetFilterLogs(MOCK_PRIVACY_GROUP_ID.toString(),
                           "0x13e9b67497fa859338ecba166752591b")
        .send();
