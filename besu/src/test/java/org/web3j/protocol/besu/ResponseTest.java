...
public class ResponseTest extends ResponseTester {
  ...
  public void testClicqueGetSigners() {
    ...
    assertEquals(ethAccounts.getAccounts().toString(),
  ...
  public void testClicqueProposals() {
    ...
    assertEquals(mapResponse.getAccounts().toString(),
  ...
  public void testIbftGetValidatorMetrics() {
    ...
    BesuSignerMetrics signerMetrics =
        deserialiseResponse(BesuSignerMetrics.class);
    assertEquals(signerMetrics.getSignerMetrics().get(0).getAddress(),
                 "0x42eb768f2244c8811c63729a21a3569731535f07");

    assertEquals(
        signerMetrics.getSignerMetrics().get(0).getProposedBlockCount(),
        BigInteger.ZERO);
  ...
  public void testPrivGetPrivateTransactionLegacy() {
    ...
    PrivateTransactionLegacy privateTransaction = new PrivateTransactionLegacy(
        ...
        "0x00", "0x407d73d8a49eeb85d32cf465507dd71d507100c1",
    ...
    assertEquals(privPrivateTransaction.getPrivateTransaction().get(),
                 (privateTransaction));
  }
  ...
  public void testPrivGetPrivateTransactionNull() {
    ...
    PrivGetPrivateTransaction privPrivateTransaction =
        deserialiseResponse(PrivGetPrivateTransaction.class);
    assertEquals(privPrivateTransaction.getPrivateTransaction(),
                 (Optional.empty()));
  }
  ...
  public void testPrivGetPrivacyPrecompileAddress() {
    ...
    assertEquals(privGetPrivacyPrecompileAddress.getAddress(),
  ...
  public void testPrivCreatePrivacyGroup() {
    ...
    assertEquals(privCreatePrivacyGroup.getPrivacyGroupId().toString(),
  ...
  public void testPrivDeletePrivacyGroup() {
    ...
    BooleanResponse privDeletePrivacyGroup =
  ...
  public void testPrivFindPrivacyGroup() {
    ...
    PrivacyGroup privacyGroup1 = new PrivacyGroup(
        ...
        PrivacyGroup.Type.LEGACY, "PrivacyGroupName", "PrivacyGroupDescription",
        Base64String.wrapList("A1aVtMxLCUHmBVHXoZzzBgPbW/wj5axDpW9X8l91SGo="));
    PrivacyGroup privacyGroup2 = new PrivacyGroup(
        "A1aVtMxLCUHmBVHXoZzzBgPbW/wj5axDpW9X8l91SGo=",
        PrivacyGroup.Type.PANTHEON, "PrivacyGroupName",
        "PrivacyGroupDescription",
        Base64String.wrapList("A1aVtMxLCUHmBVHXoZzzBgPbW/wj5axDpW9X8l91SGo="));
    PrivacyGroup privacyGroup3 = new PrivacyGroup(
        "A1aVtMxLCUHmBVHXoZzzBgPbW/wj5axDpW9X8l91SGo=",
        PrivacyGroup.Type.ONCHAIN, null, null,
        Base64String.wrapList("A1aVtMxLCUHmBVHXoZzzBgPbW/wj5axDpW9X8l91SGo="));

    PrivFindPrivacyGroup privFindPrivacyGroup =
        deserialiseResponse(PrivFindPrivacyGroup.class);
    assertEquals(privFindPrivacyGroup.getGroups(),
  ...
  public void testPrivGetTransactionReceipt() {
    ...
    PrivateTransactionReceipt transactionReceipt = new PrivateTransactionReceipt(
        "0xb60e8dd61c5d32be8058bb8eb970870f07233155",
        "0x407d73d8a49eeb85d32cf465507dd71d507100c1",
        "0x85h43d8a49eeb85d32cf465507dd71d507100c1",
        "myRlpEncodedOutputFromPrivateContract",
        Collections.singletonList(new Log(
            false, "0x1", "0x0",
        ...
        "A1aVtMxLCUHmBVHXoZzzBgPbW/wj5axDpW9X8l91SGo=", null,
        "Qlv2Jhn3C3/2KrPU7Jeu/9F6rElio9LNBSieb0Xk/Ro=", "0x1", null);

    PrivGetTransactionReceipt privGetTransactionReceipt =
        deserialiseResponse(PrivGetTransactionReceipt.class);

    assertEquals(privGetTransactionReceipt.getTransactionReceipt().get(),
                 (transactionReceipt));
  }
}
