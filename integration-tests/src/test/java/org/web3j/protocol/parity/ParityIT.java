...
public class ParityIT {
  ...
  public void testPersonalListAccounts() throws Exception {
    PersonalListAccounts personalListAccounts =
        parity.personalListAccounts().send();
  ...
  public void testPersonalUnlockAccount() throws Exception {
    ...
    PersonalUnlockAccount personalUnlockAccount =
        parity
            .personalUnlockAccount(newAccountIdentifier.getAccountId(),
                                   PASSWORD)
            .send();
  ...
  public void testPersonalSign() throws Exception {
    ...
    // result :
    // 0x80ab45a65bd5acce92eac60b52235a34eee647c8dbef8e62108be90a4ac9a22222f87dd8934f
