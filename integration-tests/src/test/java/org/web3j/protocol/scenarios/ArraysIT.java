...
public class ArraysIT extends Scenario {
  ...
  public void setUp() throws Exception {
    super.setUp();
    this.contract =
        Arrays.deploy(web3j, ALICE, new DefaultGasProvider()).send();
  }
  ...
  public void testFixedReverse() throws Exception {
    ...
    final List<BigInteger> array = java.util.Arrays.asList(
        valueOf(10), valueOf(9), valueOf(8), valueOf(7), valueOf(6), valueOf(5),
        valueOf(4), valueOf(3), valueOf(2), valueOf(1));
  ...
  public void testDynamicReverse() throws Exception {
    ...
    final List<BigInteger> array =
        java.util.Arrays.asList(valueOf(3), valueOf(2), valueOf(1));
  ...
  public void testMultiDynamic() throws Exception {
    ...
    final List<BigInteger> array1 =
        java.util.Arrays.asList(valueOf(1), valueOf(2));

    final List<BigInteger> array2 =
        java.util.Arrays.asList(valueOf(3), valueOf(4));

    final List result =
        contract.multiDynamic(java.util.Arrays.asList(array1, array2)).send();

    assertEquals(result, (java.util.Arrays.asList(valueOf(1), valueOf(2),
                                                  valueOf(3), valueOf(4))));
  }
  ...
  public void testMultiFixed() throws Exception {
    ...
    final List<BigInteger> array3 =
        java.util.Arrays.asList(valueOf(5), valueOf(6));

    final List<BigInteger> array4 =
        java.util.Arrays.asList(valueOf(7), valueOf(8));

    final List<BigInteger> array5 =
        java.util.Arrays.asList(valueOf(9), valueOf(10));

    final List<BigInteger> array6 =
        java.util.Arrays.asList(valueOf(11), valueOf(12));
    ...
    assertEquals(result,
                 (java.util.Arrays.asList(
                     valueOf(1), valueOf(2), valueOf(3), valueOf(4), valueOf(5),
                     valueOf(6), valueOf(7), valueOf(8), valueOf(9),
