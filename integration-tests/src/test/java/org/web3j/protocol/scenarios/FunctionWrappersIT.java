 ...
 *
 * <p>Generated via running org.web3j.codegen.SolidityFunctionWrapperGenerator
 * with params: <em>project-home</em>/src/test/resources/solidity/fibonacci.abi
 * -o <em>project-home</em>/src/integration-test/java -p org.web3j.generated
 */
public class FunctionWrappersIT extends Scenario {
  ...
  public void testFibonacci() throws Exception {
    Fibonacci fibonacci = Fibonacci.load(
        ...
        Web3j.build(new HttpService()), ALICE, STATIC_GAS_PROVIDER);
  ...
  public void testFibonacciNotify() throws Exception {
    ...
    Fibonacci.NotifyEventResponse result =
