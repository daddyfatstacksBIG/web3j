...
/**
 * Integration test demonstrating integration with Greeter contract taken from
 * the <a
 * href="https://github.com/ethereum/go-ethereum/wiki/Contract-Tutorial">Contract
 * Tutorial</a> on the Go Ethereum Wiki.
 */
public class GreeterContractIT extends Scenario {
  ...
  public void testGreeterContract() throws Exception {
    ...
    assertThat(createTransactionReceipt.getTransactionHash(),
               is(createTransactionHash));
    ...
    String responseValue =
        callSmartContractFunction(getFunction, contractAddress);
  ...
  private String sendCreateContractTransaction() throws Exception {
    ...
    Transaction transaction = Transaction.createContractTransaction(
        ALICE.getAddress(), nonce, GAS_PRICE, GAS_LIMIT, BigInteger.ZERO,
