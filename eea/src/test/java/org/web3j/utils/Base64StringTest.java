...
public class Base64StringTest {
  ...
  private static final String BASE64_1 =
      "A1aVtMxLCUHmBVHXoZzzBgPbW/wj5axDpW9X8l91SGo=";
  private static final byte[] BASE64_BYTES_1 =
      new byte[] {3,   86,  -107, -76, -52, 75,  9,   65,  -26, 5,  81,
                  -41, -95, -100, -13, 6,   3,   -37, 91,  -4,  35, -27,
                  -84, 67,  -91,  111, 87,  -14, 95,  117, 72,  106};
  private static final String BASE64_2 =
      "Ko2bVqD+nNlNYL5EE7y3IdOnviftjiizpjRt+HTuFBs=";
  private static final byte[] BASE64_BYTES_2 =
      new byte[] {42, -115, -101, 86,  -96, -2,  -100, -39, 77, 96,  -66,
                  68, 19,   -68,  -73, 33,  -45, -89,  -66, 39, -19, -114,
                  40, -77,  -90,  52,  109, -8,  116,  -18, 20, 27};
  private static final String BASE64_3 =
      "DyAOiF/ynpc+JXa2YAGB0bCitSlOMNm+ShmB/7M6C4w=";
  private static final byte[] BASE64_BYTES_3 =
      new byte[] {15,  32,  14, -120, 95,   -14, -98, -105, 62, 37,  118,
                  -74, 96,  1,  -127, -47,  -80, -94, -75,  41, 78,  48,
                  -39, -66, 74, 25,   -127, -1,  -77, 58,   11, -116};

  private static final List<String> BASE64_LIST =
      Arrays.asList(BASE64_1, BASE64_1);
