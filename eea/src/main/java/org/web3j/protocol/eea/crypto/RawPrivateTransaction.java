 ...
 * For the specification, refer to p4 of the <a
...
public class RawPrivateTransaction extends RawTransaction {
  ...
  protected RawPrivateTransaction(
      ...
      final BigInteger gasLimit, final String to, final String data,
      final Base64String privateFrom, final List<Base64String> privateFor,
      final Base64String privacyGroupId, final Restriction restriction) {
  ...
  protected RawPrivateTransaction(
      final BigInteger nonce, final BigInteger gasPremium,
      final BigInteger feeCap, final BigInteger gasLimit, final String to,
      final String data, final Base64String privateFrom,
      final List<Base64String> privateFor, final Base64String privacyGroupId,
  ...
  private RawPrivateTransaction(final RawTransaction rawTransaction,
                                final Base64String privateFrom,
                                final List<Base64String> privateFor,
                                final Base64String privacyGroupId,
                                final Restriction restriction) {
    this(rawTransaction.getNonce(), rawTransaction.getGasPrice(),
         ...
         rawTransaction.getData(), privateFrom, privateFor, privacyGroupId,
         restriction);
  }

  public static RawPrivateTransaction
  createContractTransaction(final BigInteger nonce, final BigInteger gasPrice,
  ...
  public static RawPrivateTransaction
  createTransaction(final BigInteger nonce, final BigInteger gasPrice,
  ...
  public static RawPrivateTransaction createTransactionEIP1559(
      ...
      final BigInteger feeCap, final BigInteger gasLimit, final String to,
      final String data, final Base64String privateFrom,
      final List<Base64String> privateFor, final Restriction restriction) {

    return new RawPrivateTransaction(nonce, gasPremium, feeCap, gasLimit, to,
                                     data, privateFrom, privateFor, null,
                                     restriction);
  }
  ...
  public static RawPrivateTransaction createTransactionEIP1559(
    ...
    return new RawPrivateTransaction(nonce, gasPremium, feeCap, gasLimit, to,
                                     data, privateFrom, null, privacyGroupId,
                                     restriction);
  }
  ...
  RawTransaction asRawTransaction() {
    return RawTransaction.createTransaction(getNonce(), getGasPrice(),
                                            getGasLimit(), getTo(),
                                            BigInteger.ZERO, getData());
  }
}
