...
public class SignedRawPrivateTransaction
    extends RawPrivateTransaction implements SignatureDataOperations {
  ...
  public SignedRawPrivateTransaction(
      ...
      final Sign.SignatureData signatureData, final Base64String privateFrom,
      final List<Base64String> privateFor, final Base64String privacyGroupId,
      final Restriction restriction) {
    super(nonce, gasPrice, gasLimit, to, data, privateFrom, privateFor,
          privacyGroupId, restriction);
  ...
  public SignedRawPrivateTransaction(
      final SignedRawTransaction signedRawTransaction,
      final Base64String privateFrom, final Base64String privacyGroupId,
      final Restriction restriction) {
  ...
  private SignedRawPrivateTransaction(
    ...
    this(signedRawTransaction.getNonce(), signedRawTransaction.getGasPrice(),
         ...
         signedRawTransaction.getSignatureData(), privateFrom, privateFor,
         privacyGroupId, restriction);
  }
